...
export default function JpgToPngClient() {
    ...
    return (
        <ToolLayout
            title="JPG to PNG"
            description="Convert JPG images to PNG format - supports multiple files"
        >
            ...
            <div className="space-y-6">
                ...
                {files.length > 0 && (
                    ...
                    >
                        Convert {files.length} file{files.length > 1 ? 's' : ''} to PNG
                    </ConvertButton>
                )}
            ...
            <div className="mt-16">
                <SimilarTools currentTool="jpg-to-png" />
            </div>
        </ToolLayout>
    );
}
