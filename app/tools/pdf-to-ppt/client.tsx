...
export default function PdfToPptClient() {
    ...
    return (
        <ToolLayout
            ...
            description="Convert PDF files to editable PowerPoint presentations - supports multiple files"
        >
            ...
            <div className="space-y-6">
                ...
                {files.length > 0 && (
                    ...
                    >
                        Convert {files.length} file{files.length > 1 ? 's' : ''} to PowerPoint
                    </ConvertButton>
                )}
            ...
            <div className="mt-16">
                <SimilarTools currentTool="pdf-to-ppt" />
            </div>
        </ToolLayout>
    );
}
