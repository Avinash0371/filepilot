...
export default function PdfToPngClient() {
    ...
    return (
        <ToolLayout
            title="PDF to PNG"
            description="Convert PDF pages to PNG images - supports multiple files"
        >
            ...
            <div className="space-y-6">
                ...
                {files.length > 0 && (
                    ...
                    >
                        Convert {files.length} PDF{files.length > 1 ? 's' : ''} to PNG
                    </ConvertButton>
                )}
            ...
            <div className="mt-16">
                <SimilarTools currentTool="pdf-to-png" />
            </div>
        </ToolLayout>
    );
}
