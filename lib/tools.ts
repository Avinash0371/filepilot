...
import {
  FileText, File, FilePlus, Scissors, Minimize2,
  Image as ImageIcon, ImagePlus, Palette, Eraser, Globe,
  ScanText, FileType, Archive, FolderOpen, Music,
  Video, Film, FileImage
} from 'lucide-react';
